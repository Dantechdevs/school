...
def edit_student(request, slug):
    ...
    if request.method == "POST":
        ...
        section = request.POST.get("section")
        student_image = (
            request.FILES.get("student_image")
            if request.FILES.get("student_image")
            else student.student_image
        )
        ...
        student.save()
        create_notification(
            request.user, f"Updated Student: {student.first_name} {student.last_name}"
        )
        messages.success(request, "Student updated successfully")
        return redirect("student_list")

    return render(
        request, "students/edit-student.html", {"student": student, "parent": parent}
    )
